\chapter{El Principio de Máxima Entropía y los modelos de grano grueso}
\label{ch:2}
...
\input{chapter2/densityoperator}
\input{chapter2/entropy}
\input{chapter2/maxent}
\input{chapter2/coarsegraining}
