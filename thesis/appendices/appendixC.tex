...
\end{equation}
donde $U_{1,j}\in\unitaryspace{2}$ y $U_{1,t}=U_{2,t}$. Debido a que el promedio es lineal, la dinámica simétrica se factoriza cuando se utiliza la aplicación de asignación promedio. Para ver esto, nótese que \acnote{pedirle a David ayuda con el último paso}
\begin{align}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{\acnote{CAPTION: VER NOMBRE DE ARCHIVO}}\label{ap:EffDunAVGvsMaxEnt1}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{\acnote{CAPTION: VER NOMBRE DE ARCHIVO}}\label{ap:EffDunAVGvsMaxEnt2}
\end{figure}
...
\acnote{tengo figuras no muy interesantes, toca enseñárselas a David a ver qué opina}
...
\acnote{Creo que es lo mismo para los canales de despolarización. Lo demuestro mañana.}