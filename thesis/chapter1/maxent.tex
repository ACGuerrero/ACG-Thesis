...
Como tratamos con un sistema en equilibrio térmico con un reservorio térmico a una temperatura $T$, la física estadística establece que $S_{G}$ coincide con la entropía termodinámica y
\begin{equation}
    \lambda=\frac{1}{T}.\nonumber
\end{equation}
