...
El principio de máxima entropía fue introducido por E. T. Jaynes en 1957 \ddnote{[cita]}. En su artículo, \textit{Information Theory and Statistical Mechanics}: Jaynes afirma que la distribución de probabilidad que maximice la entropía es la \ddnote*{estimación menos sesgada}{mejor estimación} que se puede hacer a través de la información disponible~\cite{JaynesI}. La estimación obtenida a través de la minimización de la entropía es, además, \ddnote*{aquella que no introduce suposiciones espurias sobre el sistema.}{aquella que introduce la menor cantidad de información externa al sistema.}
...
\subsubsection{\ddnote*{Principio de máxima entropía en la mecánica estadística}{El estimado de máxima entropía en mecánica estadística}}

El método anterior puede aplicarse a toda una variedad de sistemas y procesos. \ddnote*{Esto tiene varios problemas, las $\epsilon_j$ es la energía de la j-estima particula o es la energia del j-esimo microestado, ya que despues les llamas microestdos y computas la probabilidad del microestado, este ejemplo está raro, hay que discutirlo}{Considérese un sistema de $N$ partículas idénticas pero distinguibles con energías $\epsilon_{j}$}{Considérese, pues, un conjunto de $N$ partículas idénticas pero distinguibles con energías $\epsilon_{j}$}, del cual únicamente conocemos la energía promedio $E$, y que se halla en equilibrio térmico \ddnote*{con un reservorio térmico a temperatura $T$}{con un entorno que actúa como baño de calor a una temperatura $T$}. Nos interesa conocer la distribución de probabilidad de los posibles microestados $\epsilon_{j}$. Según lo discutido previamente, se busca maximizar la entropía,
