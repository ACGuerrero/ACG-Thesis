...
En esta ecuación, $\mcE_{t}$ está definido como
 ...
 \begin{enumerate}
    \item \ddnote*{$\mcE\otimes \text{id}_{k}: \mcB(\hilbert_A \otimes \hilbert_k)\to \mcB(\hilbert_B \otimes \hilbert_k)$ es positivo para todo $k=1,2,\dots$.}{$\mcE\otimes \Id_{\mcB(\hilbert_{C})}$ es positivo para cualquier $\hilbert_{C}$.}
