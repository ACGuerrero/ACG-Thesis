...
En esta ecuación, $\mcE_{t}$ está definido como
 ...
 \end{equation}
 y cumple que es un canal cuántico \acnote{también llamado aplicación dinámica \cite{Breuer} o operación cuántica \cite{Chuang}} cuántico $\forall t$, y que $\mcE_{0}=\Id_{S}$. El formalismo de los canales cuánticos queda fuera del alcance de este trabajo, y sin entrar en más detalle, basta con señalar que los canales cuánticos son aplicaciones lineales completamente positivas que preservan la traza, \ie, todo canal cuántico $\mcE:\mcB(\hilbert_{A})\rightarrow \mcB(\hilbert_{B})$ cumple que \cite{Watrous}
 \begin{enumerate}
