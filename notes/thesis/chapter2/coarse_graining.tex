...
\end{equation}
donde por $\expval{A}_{\mcF}$ nos referimos al valor esperado con respecto al estado del sistema descrito a través de \ddnote*{$\mcF(\varrho_{AB})$}{$\mcF$}.
...
\end{gather}\ddnote{el swap es hermítico, no se necesita poner daggers en ningún swap}
