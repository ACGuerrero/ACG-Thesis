...
\end{equation*}
Aunque siempre exista, la función inversa $\rfroml^{-1}$ no tiene una expresión \acnote{como se dice esto? en terminos de funciones... eh?} para todos los valores de $p$. Así que para escribir al estado de máxima entropía como una función de cantidades medibles, nos tendremos que conformar con llamar a $\rfroml^{-1}$ de manera explícita.
