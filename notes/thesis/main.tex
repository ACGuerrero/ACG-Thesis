...
\section*{Resumen}
\ddnote{tratemos de que tome forma rápido. Por fas ve llenando estos huecos que son relativamente simples, para ir revisandolos. También por fas ya haz la portada como se requiere, para concentranos ya solo en el contenido y tener todos los detalles hechos.}
El presente trabajo se utiliza el Principio de Máxima Entropía para crear una aplicación de asignación que permita hacer una conjetura sobre el estado microscópico de una descripción gruesa del estado de un sistema de $n$ qubits. En particular, la descripción gruesa corresponde a la de un aparato de medición al que se le asocian dos tipos de errores: por un lado es capaz de resolver únicamente una de las $n$ partículas, y por otro lado, existe una probabilidad no nula de que mida la $j-$-ésima partícula en lugar de la de interés. A través de la asignación de Máxima Entropía, y asumiendo que se conoce la evolución microscópica, se estudiaron diferentes dinámicas efectivas. Esto es, el cambio observable en la descripción gruesa del sistema. Las dinámicas estudiadas resultaron ser no lineales \acnote{no lineales como?}. Además, se comparan los resultados analíticos obtenidos a través de Principio de Máxima Entropía con los resultados numéricos obtenidos de otro tipo de asignación: la asignación promedio.
