    ...
    \end{block}
        ...
        \begin{equation}
            \begin{gathered}
                ...
                \varrho\mapsto\Tr_{\overline{1}}(\Fuzzy{\varrho})\pause = \sum_{k=1}^{n}p_{k}\rho_{k}.
            \end{gathered}\nonumber
        \end{equation}
    \end{block}
        \end{column}
...
\begin{frame}{Definición de la aplicación de Máxima Entropía}
            ...
            \end{center}
                \pause
                A notar \textbf{factorizabilidad}:
                \begin{equation}
                    \varrho_{\max}=\Motimes_{j=1}^{n}\rho_{k}\nonumber
                \end{equation}
            \end{block}
\end{frame}
%###########################
...
\begin{frame}{Uniendo todo}
    \begin{displaymath}
        \xymatrix{
          {\rho_{\ef}(0)} \ar[rr]^{\Gamma_{t}} \ar[d]^{\mcA^{max}_{\mcC}}
          && {\rho_{\ef}(t)}\\
          {\varrho_{max}(0)} \ar[rr]^{\mcE_{t}}
          && {\varrho_{max}(t)} \ar[u]^{\mcC}
        }
