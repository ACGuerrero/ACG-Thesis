...
\begin{frame}{Dinámica que emerge de una descripción efectiva: motivación}
    ...
    \end{columns}
    \begin{center}
        \tcbox{Un modelo de grano grueso permite estudiar dinámicas observables, exploraciones iniciales resultaban en comportamientos impropios de la mecánica cuántica}
    \end{center}
\end{frame}
%###########################
