...
Considérese, pues, que se aplica dicha aplicación borrosa a un sistema de dos partículas caracterizado por un operador de densidad $\rho\in D
\mcS(\Complex^{2}\otimes\Complex^{2})$, con $D(\Complex^{2}\otimes\Complex^{2})$ el espacio de los operadores de densidad que actúan sobre $\Complex^{2}\otimes\Complex^{2}=\Complex^{4}$. Esta acción puede escribirse como
\begin{gather}
